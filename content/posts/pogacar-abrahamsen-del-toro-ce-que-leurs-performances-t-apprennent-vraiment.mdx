...
👉 [Je veux découvrir la Méthode Watt/kg →](/systeme-watt-kg)

À très vite, Antonin

**_P.S._** _Tous les concepts abordés dans cet épisode — seuils, kilojoules, pacing, W' — sont au cœur de la méthode. Si tu veux les appliquer concrètement dès la semaine prochaine →_ [Méthode Watt/kg](/systeme-watt-kg)
