...
export default function AuthorBox() {
  return (
    <aside className="flex flex-col items-center gap-5 rounded-2xl border border-white/10 bg-surface p-6 sm:flex-row sm:items-start">
      <Image
        src="/antonin.jpg"
      ...
      <div className="text-center sm:text-left">
        ...
        <p className="mt-1 font-display text-2xl italic text-cream">
