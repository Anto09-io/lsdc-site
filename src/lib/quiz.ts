...
export const QUESTIONS: Question[] = [
  {
    ...
    options: [
      ...
      { v: "competiteur", t: "Compétiteur", d: "Je cours : route, gravel, VTT…" },
...
export const PROFILES: Record<string, Profile> = {
  bosse: {
    ...
    tagline:
      "Le moteur est là. C'est ton rapport poids-puissance qui te fait plafonner en montée.",
  ...
  longue: {
    key: "endurance-a-construire",
    name: "L'Endurance à Construire",
  ...
  course: {
    key: "repetabilite-a-construire",
    name: "La Répétabilité à Construire",
    tagline: "L'explosivité est là. Il te manque juste la répétabilité des efforts.",
  ...
  stagne: {
    key: "plateau-malgre-les-heures",
    name: "Le Plateau Malgré les Heures",
